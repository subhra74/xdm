package xdm.core.downloaders.hls;//package xdman.downloaders.hls;
//
...
//import xdman.downloaders.AbstractChunkRetriever;
...
//
//public class HlsDownloader extends Downloader
//    implements SegmentListener, MediaConversionListener, HlsEncryptedSouce {
...
//  private boolean isJavaClientRequired = true;
//
...
//
//    this.lastDownloaded = downloaded.get();
...
//      System.out.println(
//          "Non manifest segment: " + id + " manifest seg: " + manifestSegment.getId());
//      processSegments();
//    } else {
...
//
//  @Override
//  public void chunkUpdated(String id, int bytes) {
...
//
//  @Override
//  public AbstractChunkRetriever createChannel(Segment segment) {
...
//          return new EncryptedHlsChannel(
//              segment,
//              item.getUrl(),
//              metadata.getHeaders(),
//              -1,
...
//              segment, item.getUrl(), metadata.getHeaders(), -1, isJavaClientRequired);
//        }
//      }
//    }
//    Logger.log("Create manifest channel");
//    return new HttpChannel(
//        segment, metadata.getUrl(), metadata.getHeaders(), -1, isJavaClientRequired);
//  }
//
//  @Override
...
//              new File(folder, manifestSegment.getId()).getAbsolutePath(), metadata.getUrl());
//
...
//        Logger.log(
//            "Manifest media count mismatch- expected: "
//                + items.size()
//                + " got: "
...
//        HlsPlaylistItem item2 =
//            new HlsPlaylistItem(
//                item.getUrl(), item.getKeyUrl(), item.getIV(), null, null, item.getDuration());
...
//      } else if (assembling) {
//        long len = length > 0 ? length : downloaded.get();
...
//          }
//        }
//        this.downloaded .set(downloaded2);
//        if (chunks.size() > 0) {
...
//
//    sb.append(
//        keyMap != null); // if this is true that means it can have info about encrypted segments
//
//    if (keyMap != null) {
...
//            newExtension =
//                ".mkv"; // if extension is not mp4 or ts save it in MKV container, as it might be
...
//      if (!keyMap.containsKey(keyUrl)) keyMap.put(keyUrl, data);
//    }
//  }
//
//  @Override

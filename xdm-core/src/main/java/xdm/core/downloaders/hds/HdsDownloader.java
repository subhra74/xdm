package xdm.core.downloaders.hds;//package xdman.downloaders.hds;
//
...
//
//  private final byte[] flv_sig = {
//    (byte) 'F', (byte) 'L', (byte) 'V', 0x01, 0x05, 0x00, 0x00, 0x00, 0x09, 0x00, 0x00, 0x00, 0x00
//  };
//
...
//      F4MManifest mf =
//          new F4MManifest(
//              metadata.getUrl(), new File(folder, manifestSegment.getId()).getAbsolutePath());
...
//        Logger.log(
//            "Manifest media count mismatch- expected: " + urlList.size() + " got: " + urls.size());
//        return false;
//      }
//      if (urlList.size() > 0) {
//        urlList.clear();
...
//    String outFileName =
//        (outputFormat == 0
//            ? UUID.randomUUID() + "_" + getOutputFileName(true)
...
//        this.ffmpeg =
//            new FFmpeg(
//                Arrays.asList(new String[] {outFile.getAbsolutePath()}),

package xdm.core.downloaders.dash;//package xdm.downloaders.dash;
//
...
//import xdm.downloaders.Downloader;
//import xdm.downloaders.Segment;
//import xdm.downloaders.SegmentComparator;
//import xdm.downloaders.SegmentDetails;
//import xdm.downloaders.SegmentImpl;
//import xdm.downloaders.SegmentInfo;
//import xdm.downloaders.SegmentListener;
//import xdm.downloaders.http.HttpChannel;
//import xdm.downloaders.metadata.DashMetadata;
//import xdm.downloaders.metadata.HttpMetadata;
//import xdm.mediaconversion.FFmpeg;
//import xdm.mediaconversion.MediaConversionListener;
//import xdm.mediaconversion.MediaFormats;
...
//        segment,
//        url,
//        "T1".equals(segment.getTag()) ? metadata.getHeaders() : metadata.getHeaders2(),
//        len,
//        true);
//  }
//
...
//        if (length > 0) {
//          progress = (int) ((downloaded.get() * 100) / length);
//          long diff = downloaded.get() - lastDownloaded;
//          long timeSpend = now - prevTime;
//          if (timeSpend > 0) {
//            float rate = ((float) diff / timeSpend) * 1000;
//            // downloadSpeed = rate;
//            this.eta = FormatUtilities.getETA(length - downloaded.get(), rate);
//            if (this.eta == null) {
//              this.eta = "---";
//            }

...
//      return false;
//    }
//    firstLength = response.contentLength;
//    if (length > 0) {
...
//        && XDMUtils.getFreeSpace(null) < response.contentLength) {
//      logger.error("{}: Disk is full", chunk.getId());
//      errorCode = ErrorCode.DISK_FAILURE;
//      return false;
//    }
//
//    in = response.inputStream;
//    redirected = this.response.isRedirected;
//    if (redirected && this.response.finalUrl != null) {
//      redirectUrl = this.response.finalUrl.toString();
//    }

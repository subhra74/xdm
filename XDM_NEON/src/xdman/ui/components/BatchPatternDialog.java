...
public class BatchPatternDialog extends JFrame implements ActionListener, DocumentListener, ChangeListener {
	...
	private void initUI() {
		...
		spFromModelNum = new SpinnerNumberModel(new Integer(0), new Integer(0), new Integer(9999), new Integer(1));
		spToModelNum = new SpinnerNumberModel(new Integer(100), new Integer(0), new Integer(9999), new Integer(1));

...
public class DownloadQueue {
  ...
  private int index;
  private String name;
  private ArrayList<Long> queuedItems;
...
//    QueueManager.getInstance().saveQueues();
  ...
  public ArrayList<Long> getQueuedItems() {
    return queuedItems;
  }
  ...
  public final void setQueuedItems(ArrayList<Long> queuedItems) {
    this.queuedItems = queuedItems;
  }

  public final synchronized void reorderItems(ArrayList<Long> newOrder) {
    ArrayList<Long> newList = new ArrayList<>();
    for (var s : newOrder) {
      newList.add(s);
    }
    for (var id : this.queuedItems) {

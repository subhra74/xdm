...
public class BrowserMonitor implements Runnable {
  ...
  //      }
  //      Files.writeString(
  //          Paths.get(System.getProperty("user.home"), ".xdman", "settings.json"), getSync());
  //      Files.writeString(
  //          Paths.get(System.getProperty("user.home"), ".xdman", "settings_updated"), "");
  //    } catch (IOException e) {
  //      e.printStackTrace();
  //    }
  //  }
  ...
  //      sb.append(
  //          String.format("{\"id\": \"%s\", \"text\": \"%s\",\"info\":\"%s\"}", id, text, info));
  //      count++;
  //    }
  //    json.append("\n\"vidList\": [");
  ...
  //      json.append(
  //          "blockedHosts:" + String.join(",", Config.getInstance().getBlockedHosts()) + "\n");
  ...
  //            String.join(
  //                "|",
  //                Base64.encode(id.getBytes("utf-8")),
  //                Base64.encode(text.getBytes("utf-8")),
  //                Base64.encode(info.getBytes("utf-8"))));
  //      }
...
//    }
  ...
  //      fc =
  //          FileChannel.open(
  //              Paths.get(System.getProperty("user.home"), XDMApp.GLOBAL_LOCK_FILE),
  //              EnumSet.of(

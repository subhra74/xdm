...
//import xdm.core.downloaders.SegmentDetails;
//import xdman.Config;
...
//
//  public DownloadWindow(long id, DownloadWindowListener listener) {
//    this.id = id;
...
//  }
//
//  public void update(AbstractDownloader d, String file) {
//    titleLbl.setText(file);
//    if (d.getProgress().get() > 0) {
...
//    lblDet.setText(
//        (d.isAssembling()
//                ? StringResource.get("STAT_ASSEMBLING")
//                : StringResource.get("DWN_DOWNLOAD"))
//            + " "
...
//        taskbar.setWindowProgressValue(this, d.getProgress().get());
//      }
//    }
//  }
//
...
//    minBtn.setIcon(
//        ImageResource.getIcon("title_min.png", 20, 20)); // ImageResource.get("title_min.png"));
...
//  }
//
//  private void changeFile(long id) {

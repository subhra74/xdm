...
//        JFileChooser jfc =
//            XDMFileChooser.getFileChooser(
//                JFileChooser.DIRECTORIES_ONLY, new File(Config.getInstance().getDownloadFolder()));
...
//        if (!Config.getInstance().isNoTransparency()) setOpacity(0.85f);
//      }
//    } catch (Exception e) {
//      Logger.log(e);
//    }
...
//    closeBtn.setBounds(
//        getWidth() - getScaledInt(35), getScaledInt(5), getScaledInt(30), getScaledInt(30));
...
//        getScaledInt(90),
//        y + getScaledInt(5),
//        getScaledInt(305) - getScaledInt(15) + getScaledInt(50),
//        getScaledInt(20));
//    add(cmbFilter);
...
//        getScaledInt(90),
//        y + getScaledInt(5),
//        getScaledInt(305) - getScaledInt(15),
//        getScaledInt(20));
...
//    browse.setBounds(
//        getScaledInt(410) - getScaledInt(20),
//        y + getScaledInt(5),
//        getScaledInt(40),
//        getScaledInt(20));
...
//    btnCn.setBounds(
//        getWidth() - getScaledInt(15) - getScaledInt(100) - getScaledInt(110),
//        y,
//        getScaledInt(100),
//        h);
//    btnCn.setName("CLOSE");

...
namespace XDM.GtkUI.Dialogs.QueueScheduler
{
    internal class QueueSchedulerDialog : Dialog, IQueuesWindow
    {
        ...
        private QueueSchedulerDialog(Builder builder, Window parent, WindowGroup group, IAppUIController appUI) : base(builder.GetRawOwnedObject("dialog"))
        {
        ...
        public static QueueSchedulerDialog CreateFromGladeFile(Window parent, WindowGroup group, IAppUIController appUI)
        {

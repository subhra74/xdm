...
//import xdm.App;
//import xdm.core.downloaders.hls.HlsPlaylist;
//import xdm.core.downloaders.hls.HlsPlaylistItem;
//import xdm.core.downloaders.hls.PlaylistParser;
...
//					App.getInstance().addMedia(metadata, file + ".ts", "HLS");
//				}
//			} else {
...
//						}
//						System.out.println("adding media");
//						App.getInstance().addMedia(metadata, file + ".ts", infoStr.toString());
//					}
//				}
//			}
//			return true;

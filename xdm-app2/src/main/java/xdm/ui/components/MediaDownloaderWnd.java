...
//import xdm.videoparser.ThumbnailDownloader;
//import xdm.videoparser.ThumbnailListener;
//import xdm.videoparser.YdlResponse;
//import xdm.videoparser.YdlResponse.YdlMediaFormat;
//import xdm.videoparser.YdlResponse.YdlVideo;
//import xdm.videoparser.YoutubeDLHandler;
//
...
//		HttpDownloadMetadata md = null;
//		switch (fmt.type) {
//		case YdlResponse.DASH_HTTP:
//			DashMetadata dm = new DashMetadata();
//			dm.setOriginPage(txtURL.getText());
...
//			md = new HlsMetadata();
//			md.setOriginPage(txtURL.getText());
//			md.setUrl(fmt.url);
//			for (HttpHeader header : fmt.headers) {
...
//			hm.setOriginPage(txtURL.getText());
//			hm.setUrl(fmt.url);
//			for (HttpHeader header : fmt.headers) {
...
//			HttpDownloadMetadata ht = new HttpDownloadMetadata();
//			ht.setOriginPage(txtURL.getText());
//			ht.setUrl(fmt.url);
//			for (HttpHeader header : fmt.headers) {
...
//		if (wp != null) {
//			App.getInstance().addVideo(wp.md, wp.file);
//		}
//	}
//

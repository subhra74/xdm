package xdm.ui.components;//package xdm.ui.components;
//
...
//
//  private void start() {
//    HttpDownloadMetadata metadata = new HttpDownloadMetadata();
//    metadata.setUrl(url);
//    System.out.println(url);
//    d =
//        new HttpDownloader(
//            metadata.getId(), Config.getInstance().getTemporaryFolder(), metadata, this);
//
//    d.start();
//  }
//
...
//        new EmptyBorder(getScaledInt(10), getScaledInt(10), getScaledInt(10), getScaledInt(10)));
...
//    btn.setBounds(
//        getBounds().width - getScaledInt(80) - getScaledInt(20),
//        getBounds().height - getScaledInt(80),
//        getScaledInt(80),
//        getScaledInt(30));
//    add(btn);
//
...
//            this,
//            "Are you sure you want to cancel component downloads?",
//            "Confirm",

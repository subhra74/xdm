...
//import xdm.ui.components.MediaDownloaderWnd.VideoWrapper;
...
//			HttpDownloadMetadata metadata = vw.md;
//			App.getInstance().createDownload(file, folder, metadata, q == null, q == null ? "" : q.getQueueId(), 0,
//					0);
//		}
//	}
//
